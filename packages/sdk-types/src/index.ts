// @cbxss/tack-sdk-types — the single schema→TypeScript compiler and type renderers.
// `@cbxss/tack-generator` uses `compileSchema` + the method-tree renderers for the
// static SDK and `renderToolsAmbientDts` for `.tack/generated/tools.d.ts`;
// `@cbxss/tack-codemode` uses `compileSchema` for `describe.tool` and
...
// (`typeSegment`, operation type-name assignment) live in `@cbxss/tack-core`.
